...
public partial class @MainActions : IInputActionCollection2, IDisposable
{
    ...
    public struct BuildActions
    {
        ...
        public void SetCallbacks(IBuildActions instance)
        {
            ...
            {
                @Touch.started -= m_Wrapper.m_BuildActionsCallbackInterface.OnTouch;
                @Touch.performed -= m_Wrapper.m_BuildActionsCallbackInterface.OnTouch;
                @Touch.canceled -= m_Wrapper.m_BuildActionsCallbackInterface.OnTouch;
